...
const Footer = () => {
  return (
    ...
    //   </div>
    // </footer>
    <footer class="p-4 sm:p-6 dark:bg-gray-800 bg-gray-300 text-black h-auto m-6 rounded-lg">
      <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="/" class="flex items-center">
              <img src={Icon} class="mr-3 h-12" alt="Boxit Logo" />
              {/* <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Boxit</span> */}
            </a>
          </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">Boxit™</a>.  All Rights Reserved.
          </span>
          <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/boxitCargo" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
